...
function Hero() {
  return (
    <div className='md:h-screen h-[110vh] w-full bg-cover bg-center bg-[url(/image.avif)]'>
        ...
        <div className="absolute right-4 top-0 w-72 h-72 rounded-full bg-fuchsia-400/40  filter blur-2xl circle-animate "></div>
        ...
        <div className="md:w-[40%] w-full md:h-[80%] h-[95%] relative flex flex-col justify-center items-end md:items-center">
            <div className="md:h-82 md:w-82 h-64 w-64 rounded-full border-8 border-stone-400 relative shadow-xl shadow-gray-400/20">
              <Image src="/17717613378455.jpg" alt="me1.png" className="h-full w-full rounded-full" height={800} width={800}  />
