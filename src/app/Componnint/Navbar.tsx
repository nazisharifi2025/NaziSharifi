...
function Navbar() {
  ...
  return (
    ...
    <div className='md:w-[60%] w-10/12 border border-stone-400 mx-auto h-15 py-7 px-3 rounded-md  backdrop-blur-md  bg-stone-400/20 flex items-center justify-between'>
