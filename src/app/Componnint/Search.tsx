      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1  lg:w-10/12 w-11/12 mx-auto gap-4">
        {filtered.map((blog) => (
          // <DataCard key={blog.id} blog={blog} />
            ...
            <div className="border border-fuchsia-400/20 lg:h-[78vh] md:h-[55vh] h-fit hover:border-fuchsia-400/20 shadow-fuchsia-400/40 hover:shadow-[0_0_12px_0_rgba(0,0,0,0.3)]  rounded-md  hover:-translate-y-2 transition-all duration-700 cursor-pointer">
